...
Automatic spelling corrections for prose, using Neovim's native insert-mode abbreviations. Includes 1,031,494 lowercase typo corrections and enables them in Markdown and Git commit messages by default.
